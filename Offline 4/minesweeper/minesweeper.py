...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        newSentence = Sentence(underterminedCells, count-mycountMines)
        ...
        for sentence in self.knowledge:
            ...
            if newSentence.cells.issubset(sentence.cells) and sentence.count > 0 and newSentence.count > 0 and newSentence != sentence:
                ...
                mynewSubset = sentence.cells.difference(newSentence.cells)
                newSentenceSubset = Sentence(list(mynewSubset), sentence.count-newSentence.count)
